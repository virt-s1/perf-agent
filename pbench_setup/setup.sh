...
[ ! -f "./config/id_rsa" ] && curl ${PRODUCTION_SSHKEY} -o ./config/id_rsa
[ ! -f "./config/pbench-agent-production.cfg" ] && curl ${PRODUCTION_CONFIG} -o ./config/pbench-agent-production.cfg

[ ! -f "./config/id_rsa.cloud" ] && curl ${CLOUDS_SSHKEY} -o ./config/id_rsa.cloud
[ ! -f "./config/pbench-agent-cloud.cfg" ] && curl ${CLOUDS_CONFIG} -o ./config/pbench-agent-cloud.cfg
